...
int main(){
    ...
    printf("\n=== CARTA 1 ===\n"); // CARTA 1, PERGUNTANDO AO USUÁRIO OS RESPECTIVOS DADOS:
    ...
    printf("\n=== CARTA 2 ===\n"); // CARTA 2, PERGUNTANDO AO USUÁRIO OS RESPECTIVOS DADOS:
    ...
    dens_populacional2 = (populacao2 / area2); // FÓRMULA PARA ACHAR DENSIDADE POPULACIONAL

    pib_capita2 = (pib2 * 1000000000) / populacao2; // FÓRMULA PARA ACHAR PIB PER CAPITA 

    

    printf("\nCarta 1:\n"); // EXIBE OS DADOS INFORMADOS PELO USUÁRIO DA CARTA 1
    printf("ESTADO: %s \n", estado);
    printf("CODIGO: %s \n", codigo);
    ...
    printf("\nCarta 2: \n"); // EXIBE OS DADOS INFORMADOS PELO USUÁRIO DA CARTA 2
    printf("ESTADO: %s \n", estado2);
    printf("CODIGO: %s \n", codigo2);
    ...
    printf("=== MENU DE COMPARAÇÃO ==="); // MENU PARA FAZER A COMPARAÇÃO USANDO SWITCH CASE
    printf("1. POPULAÇÃO\n");
    printf("2. ÁREA\n");
    printf("3. PIB\n");
    ...
    case 1:
        ...
        } else if (populacao < populacao2)
        {
            ...
            printf("EMPATE\n"); // INPLEMENTANDO O ELSE PARA RETORNAR EMPATE CASO ACONTEÇA.   
        }
        break;
    case 2:
